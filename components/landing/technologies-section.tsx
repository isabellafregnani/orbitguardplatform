...
const technologies = [
  {
    name: 'React',
    description: 'Interface moderna e reativa',
    icon: (
  ...
  {
    name: 'APIs Espaciais',
    description: 'Dados de agências espaciais',
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8" fill="currentColor">
  ...
  },
  {
    ...
    description: 'Previsão de colisões',
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8" fill="currentColor">
  ...
  {
    name: 'Banco de Dados',
    description: 'Armazenamento escalável',
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8" fill="currentColor">
  ...
  {
    name: 'Análise Orbital',
    description: 'Cálculos de trajetória',
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8" fill="currentColor">
  ...
  {
    name: 'Next.js',
    description: 'Framework de produção',
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8" fill="currentColor">
...
export function TechnologiesSection() {
  return (
    <section id="tecnologias" className="relative py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground text-pretty">
            Nossa stack tecnológica foi cuidadosamente selecionada para garantir 
